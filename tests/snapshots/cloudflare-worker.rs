...
extern "C" {
    ...
    pub fn new_with_slice(init: &[ArrayTuple<(JsString, JsString)>]) -> Result<Headers, JsValue>;
    #[wasm_bindgen(method)]
    ...
    #[wasm_bindgen(method)]
    pub fn entries(this: &Headers) -> Iterator<ArrayTuple<(JsString, JsString)>>;
    #[wasm_bindgen(method, catch, js_name = "entries")]
    pub fn try_entries(
        this: &Headers,
    ) -> Result<Iterator<ArrayTuple<(JsString, JsString)>>, JsValue>;
    #[wasm_bindgen(method)]
    pub fn keys(this: &Headers) -> Iterator<JsString>;
    #[wasm_bindgen(method, catch, js_name = "keys")]
    pub fn try_keys(this: &Headers) -> Result<Iterator<JsString>, JsValue>;
    #[wasm_bindgen(method)]
    pub fn values(this: &Headers) -> Iterator<JsString>;
    #[wasm_bindgen(method, catch, js_name = "values")]
    pub fn try_values(this: &Headers) -> Result<Iterator<JsString>, JsValue>;
}
#[allow(dead_code)]
...
extern "C" {
    ...
    #[wasm_bindgen(method, catch)]
    pub async fn json<T: ::wasm_bindgen::JsGeneric>(this: &Request) -> Result<T, JsValue>;
    #[wasm_bindgen(method, catch)]
...
extern "C" {
    ...
    pub fn set_headers_with_slice(this: &RequestInit, val: &[ArrayTuple<(JsString, JsString)>]);
    #[wasm_bindgen(method, getter)]
...
impl RequestInitBuilder {
    ...
    pub fn headers_with_slice(self, val: &[ArrayTuple<(JsString, JsString)>]) -> Self {
        self.inner.set_headers_with_slice(val);
        self
    }
...
extern "C" {
    ...
    pub async fn json_2<T: ::wasm_bindgen::JsGeneric>(this: &Response) -> Result<T, JsValue>;
    #[wasm_bindgen(method, catch)]
...
extern "C" {
    ...
    #[wasm_bindgen(method, setter, slice_to_array, js_name = "headers")]
    pub fn set_headers_with_slice(this: &ResponseInit, val: &[ArrayTuple<(JsString, JsString)>]);
}
impl ResponseInit {
...
extern "C" {
    # [wasm_bindgen (extends = Object)]
    #[derive(Debug, Clone, PartialEq, Eq)]
    pub type ExportedHandler<E: ::wasm_bindgen::JsGeneric>;
    #[wasm_bindgen(method, catch)]
    pub async fn fetch<E: ::wasm_bindgen::JsGeneric>(
        this: &ExportedHandler<E>,
        request: &Request,
        env: &E,
        ctx: &ExecutionContext,
    ) -> Result<Response, JsValue>;
    #[wasm_bindgen(method, catch)]
    pub async fn scheduled<E: ::wasm_bindgen::JsGeneric>(
        this: &ExportedHandler<E>,
